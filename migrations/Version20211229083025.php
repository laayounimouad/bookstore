 ...
 */
final class Version20211229083025 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE livre (id INT AUTO_INCREMENT NOT NULL, isdn VARCHAR(255) NOT NULL, titre VARCHAR(255) NOT NULL, nombre_pages INT NOT NULL, date_de_parution DATE NOT NULL, note INT DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
    }
